    ...
    <div class="row">
      <div class="col-12">
        ...
        <div class="border p-1">
          ...
          <div v-else="state.player.grade === 80">
            <p>The grade is 'B'.</p>
          </div>
          <!-- v-else-if comparing grade and 70 -->
          <div v-else="state.player.grade === 70">
            <p>The grade is 'C'.</p>
          </div>
          <!-- v-else-if comparing grade and 60 -->
          <div v-else="state.player.grade === 60">
            <p>The grade is 'D'.</p>
          </div>
        ...
        <div class="border p-1">
          ...
          <div class="player-card text-center area" v-show="state.player.number > 0">
            <div>
              <img :src="state.player.photo" />
            </div>
            <div>
